...
DELIMITER $
CREATE TRIGGER log_after_update_on_rental AFTER log_after_update_on_rental ON rental FOR EACH ROW
BEGIN
    DECLARE r_id INT(4);
    DECLARE r_date DATETIME;
...
-----Trigger 4.2-----
TRIGGER payment_before_insert BEFORE INSERT ON payment FOR EACH ROW
BEGIN
    DECLARE r_id INT(4);
    DECLARE r_date DATETIME;
    DECLARE c_email;
